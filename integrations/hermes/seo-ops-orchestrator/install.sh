...
echo "  2. From Hermes, provide a site, topic, and optional requirements"
echo "     (the skill runs start.sh and completes every passing stage)"
echo "  3. If no provider is configured, use the returned material summary and either:"
echo "     scripts/continue.sh --use-existing <action_id>"
echo "     scripts/continue.sh --search-file search-results.md <action_id>"
