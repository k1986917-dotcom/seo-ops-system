...
echo "     (the skill runs start.sh for R0 + automatic search + R1)"
echo "  3. If no provider is configured, provide search results via stdin:"
echo "     scripts/r1.sh <action_id> < search-results.md"
